...
public class ProductsActivity extends AppCompatActivity implements AbsListView.OnScrollListener {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (itemId) {
                    ...
                    case R.id.nav_contact:
                        AppUtils.showToast("contact", ProductsActivity.this);
                        return true;
                    case R.id.nav_settings:
                        AppUtils.showToast("settings", ProductsActivity.this);
