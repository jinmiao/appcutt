package com.appcutt.demo.views.fragments;
...
import com.appcutt.demo.views.adapters.PhotosArrayAdapter;
import com.appcutt.demo.activity.PhotoDetailActivity;
import com.appcutt.demo.views.listeners.OnLoadMoreScrollListener;
...
public class CatsGridFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view = inflater.inflate(com.appcutt.demo.R.layout.fragment_cats_grid, container, false);
    ...
    private void initSwipeRefresh() {
        swipeRefresh.setColorSchemeResources(com.appcutt.demo.R.color.theme500);
